             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Student Assessment</h4>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="../">Assessment Instructions</a></li>
                                     <li class="breadcrumb-item active" aria-current="page"><a href="../start/">Student Assessment</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                   ...
                   <div class="comment-widgets scrollable">
                        <form method="POST">
                            <div class="d-flex flex-row comment-row m-t-0">
                                ...
                                $result = $connection->prepare("SELECT t1.drxassessment_id, t1.drxassessment_question1, 
                                                                       t1.drxassessment_q1_answer_1, t1.drxassessment_q1_answer_2,
                                                                       t1.drxassessment_q1_answer_3, t1.drxassessment_q1_answer_4,
                                                                       t1.drxassessment_answer, t1.drxassessment_order, t1.drxassessment_status
                                                                FROM drxassessment_assessment AS t1
                                                                WHERE t1.drxassessment_status = 1
                                                                ORDER BY t1.drxassessment_order DESC");
                                $result->execute();
                                ...
                                <!-- drxassessment_student_answer -->
                                    <h6 class="font-medium"><?php echo $drxassessment_question1; ?></h6>
                                    <div class="comment-footer">
                                        <div class="col-md-9">
                                            <!-- <select name="asd">
                                                <option value="2"><?php echo $drxassessment_q1_answer_1;?></option>
                                                <option value="3"><?php echo $drxassessment_q1_answer_2;?></option>
                                            </select> -->
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="" id="customControlValidation1" name="drxassessment_student_answer" value="<?php echo $drxassessment_q1_answer_1;?>" required>
                                                <label class=""><?php echo $drxassessment_q1_answer_1;?></label>
                                            </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="" id="customControlValidation2" name="drxassessment_student_answer" value="<?php echo $drxassessment_q1_answer_2;?>" required>
                                                <label class=""><?php echo $drxassessment_q1_answer_2;?></label>
                                            </div>
                                             <div class="custom-control custom-radio">
                                                <input type="radio" class="" id="customControlValidation3" name="drxassessment_student_answer" value="<?php echo $drxassessment_q1_answer_3;?>" required>
                                                <label class="" ><?php echo $drxassessment_q1_answer_3;?></label>
                                            </div>
                                             <div class="custom-control custom-radio">   
                                                <input type="radio" class="" id="customControlValidation4" name="drxassessment_student_answer" value="<?php echo $drxassessment_q1_answer_4;?>" required>
                                                <label class=""><?php echo $drxassessment_q1_answer_4;?></label> 
                                            </div>
                                ...
                                <?php } ?>
                                    <div class="pull-left">
                                        <button class="btn btn-success"><i class="fas fa-check-circle"></i> Submit</button>
                                    </div>
                                </div>
                            </div>
                         </form>
