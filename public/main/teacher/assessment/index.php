...
if(isset($_POST['erv_delete_is_key'])){
    $erv_delete_is_key = $_POST['erv_delete_is_key'];
} else {
    $erv_delete_is_key = "";
}
...
if($drx_status == "addnewassessment"){
    $erv_statement = $connection->prepare("INSERT INTO drxassessment_assessment (
                                        drxassessment_question1,
                                        drxassessment_q1_answer_1,
                                        drxassessment_q1_answer_2,
																				drxassessment_q1_answer_3,
...
<body>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Asssement Management</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
							...
							<div class="card-body">
	                          ...
	                          $result = $connection->prepare("SELECT * FROM drxassessment_assessment ORDER BY drxassessment_created_at DESC");
	                          $result->execute();
	                          ...
	                          ?>
															<tr>
																...
																<td class="text-center"><?php echo $new_drxassessment_created_at; ?></td>
																<td class="text-center" style="width: 200px;">
																	<button type="button" onclick="addAssessment();" data-toggle="modal" data-target="#" class="btn btn-warning btn-mg"><i class="ti-pencil"></i></a> Edit</button>
																	&nbsp;
																	<button type="button" onclick="addAssessment();" data-toggle="modal" data-target="#" class="btn btn-danger btn-mg"><i class="ti-trash"></i></a> Delete</button>
																</td>
															</tr>
														<?php } ?>
													</tbody>
    ...
    // function editAssessment(key, fullname, username, password, date, position)
    // {
    //       $("#usersModalLabel").html("Edit Users") ;
    //       $("#drx_status").val("editnewusers") ;
    //       $("#drx_key").val(key) ;
		//
    //       $("#fms_fullname").val(fullname) ;
    //       $("#fms_username").val(username) ;
		// 			$("#fms_password").val(password) ;
    //       $("#fms_position").val(position) ;
		//
    // }
		//
    // function deleteAssessment(key)
    // {
    //       $("#usersModalLabel").html("Delete Users") ;
    //       $("#dr_delete_is_status").val("deleteusers") ;
    //       $("#erv_delete_is_key").val(key) ;
    // }
