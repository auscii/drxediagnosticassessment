...
if($drx_status == "approvalstudentuser"){
    ...
    $drx_statement->execute(array('drxassessment_status' => 1));
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
							<div class="card-body">
	                          ...
	                          $result = $connection->prepare("SELECT * FROM drxassessment_users WHERE drxassessment_position ='5tud3nt' ORDER BY drxassessment_created_at ASC");
	                          $result->execute();
															...
															<tr>
																...
																<td class="text-center">
																  ...
																  <?php } else if($drxassessment_status == 0) {?>
																	<span class="badge badge-danger"><i class="fas fa-ban"></i> NOT ACTIVE</span>
																	<?php } ?>
																</td>
						...
						<div class="modal-content">
								...
								<div class="modal-body">
									<form method="POST">
										...
										<h4 class="card-title text-center">Are you sure you want to Approve '<span id="approval_name"></span>'?</h4>

										<center>

											  <button type="submit" class="btn btn-success"><i class="fas fa-check-circle"></i> Yes</button>&nbsp;
    ...
    function approveUser(id, name){
      $("#usersModalLabel").html("Approval of Student") ;
      $("#drx_status").val("approvalstudentuser") ;
			$("#drx_key").val(id);
			$("#approval_name").html(name);
    }
