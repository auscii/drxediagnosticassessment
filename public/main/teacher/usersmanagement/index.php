            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../../../assets/images/users/d2.jpg" alt="user" />
                                ...
                                <div class="el-card-content">
                                    <h4 class="m-b-0">Admin/Teacher</h4> <span class="text-muted">Manage User</span>
										...
										<div class="col-lg-3 col-md-6">
												<div class="card">
														<div class="el-card-item">
																<div class="el-card-avatar el-overlay-1"> <img src="../../../assets/images/users/d1.jpg" alt="user" />
																		<div class="el-overlay">
																				<ul class="list-style-none el-info">
